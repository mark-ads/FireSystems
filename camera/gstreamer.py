...
class VideoItem(QThread):
    ...
    Но пришлось от него отказаться, так как оказался несовместим с моим стеком.
    ...
    Собирал плагин для пайплайна Qml6d3d11sink, но он отказался работать с моим железом.
    '''
